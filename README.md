...
### 🛠️ Stack
[![Skills](https://skillicons.dev/icons?i=py,r,tensorflow,pytorch,sklearn,opencv,linux,bash,docker,git,githubactions,jenkins,aws,azure,anaconda,vim,sqlite,ubuntu)](https://skillicons.dev)
