...
### Stack:
[![My Skills](https://skillicons.dev/icons?i=aws,azure, docker, git, githubactions, ai, jenkins, python, r, vim, anaconda, bash, linux, opencv, pycharm, pytorch, sklearn, tensorflow, vscode)](https://skillicons.dev)
